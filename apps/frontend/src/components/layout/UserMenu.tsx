  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div
          role="menu"
          className="absolute left-0 right-0 top-full z-30 mt-2 rounded-2xl border border-line bg-white p-3 shadow-pop"
        >
          ...
          <button
            ...
            className="w-full rounded-lg border border-line px-3 py-2 text-sm text-ink transition-colors hover:bg-field disabled:opacity-60"
          >
